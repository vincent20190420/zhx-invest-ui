        ...
        <d2-crud ref="d2Crud"
            ...
            <el-row slot="header" style="margin-top: 15px;margin-bottom: 5px">
                ...
                <el-button-group style="float:right;">
                    ...
                    <el-button size="mini"
                               type="primary"
                               icon="el-icon-download" @click="importHistoryData">
                        历史数据
                    </el-button>
...
<script>
  import { stockPage, stockSave, stockUpdate, stockDelete, importHistoryData } from '@api/zhx.invest'
      ...
      importHistoryData () {
        ...
        this.$confirm('确定要下载历史数据吗', '下载历史数据', {
          type: 'warning'
            ...
            this.loading = true
          importHistoryData(ids).then(res => {
              this.$message({
                message: '下载成功',
                type: 'success'
              })
