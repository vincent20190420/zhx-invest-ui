<template>
    <div>
        <d2-crud ref="d2Crud"
            ...
            <el-button slot="header" size="mini" style="float:right;margin-top: 15px;margin-bottom: 5px" type="danger" icon="el-icon-delete"
                       @click="addRow">
                删除
            </el-button>
            <el-button slot="header" size="mini" style="float:right;margin-top: 15px;margin-bottom: 5px" type="primary" icon="el-icon-edit"
                       @click="addRow">
                <d2-icon name="new"/>
                新增
            </el-button>
